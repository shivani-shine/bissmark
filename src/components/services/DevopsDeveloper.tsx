...
import jenkins from "public/images/DevOps & Cloud/-jenkins-logo.jpg";
import amazon from "public/images/DevOps & Cloud/AMAZON-WEB-logo.jpg";
import chef from "public/images/DevOps & Cloud/Chef-logo.jpg";
import Docker from "public/images/DevOps & Cloud/Docker-Logo.jpg";
import newrelic from "public/images/DevOps & Cloud/newrelic-logo.jpg";
import puppet from "public/images/DevOps & Cloud/puppet-labs-logo.jpg";
          ...
          <div className="row align-items-center">
            <div className="col-md-6 col-sm-12 col-12">
              <h1 className="font-light">
                <span className="purpleback">Devops</span> Developers
              </h1>
              <p>
            ...
            <div className="col-md-6 col-sm-12 col-12 text-center">
              <ul className={styles.industies_list}>
                <li>
                  <span>
                    {/* <Link to={}> */}
                    <Image className="lazy_a" src={jenkins} alt="jenkins"/>
                    <h4>JENKINS</h4>
                    {/* </Link> */}
                  </span>
                </li>
                <li>
                  <span>
                  <Image className="lazy_a" src={amazon} alt="amazon web services"/>
                    <h4>AMAZON WEB SERVICES</h4>
                  </span>
                  <span>
                  <Image className="lazy_a" src={chef} alt="chef"/>
                    <h4>CHEF</h4>
                  </span>
                  <span>
                  <Image className="lazy_a" src={Docker} alt="docker"/>
                    <h4>DOCKER</h4>
                  </span>
                </li>
                <li>
                  <span>
                  <Image className="lazy_a" src={newrelic} alt="new relic"/>
                    <h4>NEW RELIC</h4>
                  </span>
                  <span>
                  <Image className="lazy_a" src={puppet} alt="puppet"/>
                    <h4>PUPPET</h4>
                  </span>
                </li>
              </ul>
