...
import appium from "public/images/Testing/appium-logo.jpg";
import automation from "public/images/Testing/automation-testing-logo.jpg";
import protractor from "public/images/Testing/protractor-logo.jpg";
import selenium from "public/images/Testing/selenium-logo.jpg";
          ...
          <div className="row align-items-center">
            <div className="col-md-6 col-sm-12 col-12">
              <h1 className="font-light">
                <span className="purpleback">Testing</span> Developers
              </h1>
              <p>
            ...
            <div className="col-md-6 col-sm-12 col-12 text-center">
              <ul className={styles.industies_list}>
                <li>
                  <span>
                    {/* <Link to={}> */}
                    <Image className="lazy_a" src={appium} alt="appium"/>
                    <h4>Appium</h4>
                    {/* </Link> */}
                  </span>
                </li>
                <li>
                  <span>
                  <Image className="lazy_a" src={automation} alt="automation"/>
                    <h4>Automation</h4>
                  </span>
                  
                  <span>
                  <Image className="lazy_a" src={protractor} alt="protractor"/>
                    <h4>Protractor</h4>
                  </span>
                </li>
                <li>
                  ...
                  <span>
                  <Image className="lazy_a" src={selenium} alt="selenium"/>
                    <h4>Selenium</h4>
                  </span>
...
export default TestingDeveloper;
