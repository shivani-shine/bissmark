...
import Android from "public/images/App Development Services/ANDROID-logo.jpg";
import ios from "public/images/App Development Services/ios-logo.jpg";
          ...
          <div className="row align-items-center">
            <div className="col-md-6 col-sm-12 col-12">
              <h1 className="font-light">
                <span className="purpleback">Mobile App</span> Developers
              </h1>
              <p>
            ...
            <div className="col-md-6 col-sm-12 col-12 text-center">
              <ul className={styles.industies_list}>
                <li>
                  <span>
                    {/* <Link to={}> */}
                    <Image className="lazy_a" src={Android} alt="android"/>
                    <h4>Android</h4>
                    {/* </Link> */}
                  </span>
                </li>
                <li>
                  <span>
                  <Image className="lazy_a" src={ios} alt="ios"/>
                    <h4>iOS</h4>
                  </span>
                </li>
              </ul>
