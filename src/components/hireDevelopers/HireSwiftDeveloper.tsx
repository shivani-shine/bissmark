  ...
  return (
    <div>
      <HireBanner
        ...
        desc={`Software development is the process of developing an individual or group of software using a programming language. Designing, 
        programming, bug fixing, and testing are the integral aspects that are covered while building a software. Our team builds customized and 
        personalized software based on the clients' needs. Businesses can thrive in competitive marketing by incorporating innovation and efficiency. 
        Our software developers turn your business goals into reality.`}
      />
      ...
      <section className={`${styles.letOurWork} ${styles.alice_Blue_bg} `}>
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-sm-4 col-md-3 col-xs-12">
              <div className={styles.our_work_box}>
                <div className={styles.our_work_icon}>
                  <Image src={retention} alt="retent" />
                </div>
...
export default HireSwiftDeveloper;
