...
const ServicesCardtwo = ({ id, title, imgSrc, body, url }:any) => {
  return (
    <div className={`col-xs-12 col-sm-6 col-md-4 ${OurServiceStyle.second_card_section} `}key={id}>
      <div className={OurServiceStyle.second_card_heading}>
